...
function LoginForm() {
  ...
  return (
    <div
      className="on-dark min-h-screen flex items-center justify-center p-4"
    ...
    >
      ...
      <div className="absolute bottom-0 right-1/4 w-64 h-64 bg-accent/8 rounded-full blur-3xl pointer-events-none" />
      ...
      >
        ...
        <div className="flex items-center gap-3 mb-8 justify-center">
          ...
          <div>
            ...
            <p className="text-xs text-white/75">Smart Resource Allocation Platform</p>
          </div>
        </div>
        ...
        <div className="rounded-2xl overflow-hidden"
          ...
          <div className="px-6 pt-6 pb-4">
            ...
            <p className="text-xs text-white/75 mt-0.5">NGO admin or volunteer account</p>
          </div>

          <form onSubmit={handleSubmit} className="px-6 pb-6 space-y-4">
            <div>
              <label className="text-xs font-medium text-white/75 block mb-1">Email</label>
            ...
            <div>
              <label className="text-xs font-medium text-white/75 block mb-1">Password</label>
              <div className="relative">
                ...
                <button type="button" onClick={() => setShowPwd(s => !s)}
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-white/75 hover:text-white/75 transition-colors">
                ...
                <motion.div key="notfound" initial={{ opacity: 0, y: -4 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }}
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <a href="/register/volunteer"
                      className="flex items-center justify-center gap-1.5 py-2.5 rounded-xl text-xs font-bold text-white transition-all hover:scale-105"
                      style={{ background: "linear-gradient(135deg,#1a7a5e,var(--brand-500))" }}>
            ...
            <div className="flex items-center justify-center gap-3 pt-1">
              <a href="/register/ngo" className="text-xs text-white/75 hover:text-subtle transition-colors flex items-center gap-1">
                <Building2 size={11} />Register NGO
              </a>
              <span className="text-white/20 text-xs">·</span>
              <a href="/register/volunteer" className="text-xs text-white/75 hover:text-subtle transition-colors flex items-center gap-1">
